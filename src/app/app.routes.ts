...
export const routes: Routes = [
  ...
  /* Main layout */
  {
    ...
    children: [
      ...
      {
        path: "about-us",
        loadComponent: () => import("./pages/about-us/about-us.component").then((c) => c.WhoWeAreComponent),
      ...
      /* Profile */
      {
        ...
        children: [
          { path: "", redirectTo: "personal", pathMatch: "full" },
          {
            path: "personal",
            loadComponent: () =>
              import("../app/pages/profile/components/profile-details/profile-details.component").then(
                (c) => c.ProfileDetailsComponent
              ),
          },
          {
            path: "orders",
            loadComponent: () =>
              import("../app/pages/profile/components/orders/orders.component").then((c) => c.OrdersComponent),
          },
          {
            path: "address",
            loadComponent: () =>
              import("../app/pages/profile/components/address/address.component").then((c) => c.AddressComponent),
          },
          {
            path: "password",
            loadComponent: () =>
              import("../app/pages/profile/components/password/password.component").then((c) => c.PasswordComponent),
          },
        ],
        data: {
      ...
      },
      {
        ...
        children: [
          { path: "", redirectTo: "personal", pathMatch: "full" },
          {
            path: "personal",
            loadComponent: () =>
              import("../app/pages/auth/register/components/personal/personal.component").then(
          ...
          },
          {
            path: "password",
            loadComponent: () =>
              import("../app/pages/auth/register/components/password/password.component").then(
          ...
          },
          {
            path: "address",
            loadComponent: () =>
              import("../app/pages/auth/register/components/address/address.component").then((c) => c.AddressComponent),
          },
        ],
        data: {
